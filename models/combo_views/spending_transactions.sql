...
, NOT(coalesce(category_l1,'null') in ('trasnfer', 'transfer', 'credit', 'betterment', 'income', 'payment', 'refund', 'reimbursement', 'water bill')) as spending_transaction_flag
...
and (category_l1 not in ('payment','income','transfer') or category_l1 is null) #}
